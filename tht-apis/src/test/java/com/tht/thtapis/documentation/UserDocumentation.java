...
import com.tht.thtapis.fixture.user.*;
...
class UserDocumentation extends ControllerTestConfig {
    ...
    void reportUserDocs() throws Exception {
        //give
        String requestBody = ControllerTestConfig.objectMapper.writeValueAsString(UserRequestFixture.make());
    ...
    void updateLocation() throws Exception {
        ...
        var resultActions = ControllerTestConfig.mockMvc.perform(
                patch("/user/location")
                    .header("Authorization", "Bearer {ACCESS_TOKEN")
                    .contentType(MediaType.APPLICATION_JSON)
                    .accept(MediaType.APPLICATION_JSON)
    ...
    void updateName() throws Exception {
        ...
        TokenDto response = TokenDtoFixture.createTokenDto();
    ...
    void deleteUserDocs() throws Exception {
        ...
        var result = ControllerTestConfig.mockMvc.perform(
