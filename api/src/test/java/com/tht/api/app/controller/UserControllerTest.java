            ...
            document("메인화면 유저 리스트 조회 docs",
                ...
                resource(
                    ResourceSnippetParameters.builder()
                        ...
                        .requestFields(
                            fieldWithPath("alreadySeenUserUuidList").description("한번 본 유저 uuid 리스트"),
                            fieldWithPath("userDailyFallingCourserIdx").description("페이징 커서 - 마지막으로 본 UserDailyFalling Idx"),
